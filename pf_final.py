...
result=[]
final_scores=[]
player_A=str(input("Enter name of player A:"))
player_B=str(input("Enter name of player B:"))
header=[player_A,player_B]
...
pen.hideturtle()
pen.goto(0,260)
pen.write(f"{player_A}: 0 vs {player_B}: 0", align="center", font=("Courier", 24, "normal"))
...
for i in range(3):
    ...
    while True:
        ...
        if ball.xcor() > 355:
            ...
            if score_a > 2:
                pen.clear()
                pen.write(f"{player_A} Wins", align="center", font=("Courier", 28, "normal"))
                time.sleep(2)
                break

            pen.clear()
            pen.write(f"{player_A}: {score_a} vs {player_B} : {score_b}".format(score_a, score_b), align="center", font=("Courier", 24, "normal"))
        ...
        if ball.xcor() < -355:
            ...
            if score_b > 2:
                pen.clear()
                pen.write(f"{player_B} Wins", align="center", font=("Courier", 28, "normal"))
                time.sleep(2)
                break
